  ...
  return (
    <main className="workspace-page">
      <header className="workspace-header">
        ...
        <div className="workspace-meta"><span className="location-label">CUBO ITAÚ · MONTEVIDEO</span><div className="user-menu"><span className="avatar">{props.user.userName.slice(0, 1)}</span><span>{props.user.userName}</span><button onClick={() => void props.onLogout()} title="Log out" aria-label="Log out"><Icon name="log-out" size={17} /></button></div></div>
      </header>
